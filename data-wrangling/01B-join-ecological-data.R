...
max_bf_overall <- ecologicaldata %>% 
  ...
  select(BinomialReptileDatabase, Sex, Family, SSM, SSBF, max_bf, max_bm, max_svl, max_hl, max_hw, max_hh, max_ljl, MainBiogeographicRealm, Lifestyle, MieriDiet, MetzgerHerrelDiet, CooperDiet, PercentPlantMatterEaten)
...
avg_bf_plus_sd_overall <- ecologicaldata %>% 
  ...
  select(BinomialReptileDatabase, Sex, Family, SSM, SSBF, bf_plus_sd, bm_plus_sd, svl_plus_sd, hl_plus_sd, hw_plus_sd, hh_plus_sd, ljl_plus_sd, MainBiogeographicRealm, Lifestyle, MieriDiet, MetzgerHerrelDiet, CooperDiet, PercentPlantMatterEaten)
...
avg_bf_plus_se_overall <- ecologicaldata %>% 
  ...
  select(BinomialReptileDatabase, Sex, Family, SSM, SSBF, bf_plus_se, bm_plus_se, svl_plus_se, hl_plus_se, hw_plus_se, hh_plus_se, ljl_plus_se, MainBiogeographicRealm, Lifestyle, MieriDiet, MetzgerHerrelDiet, CooperDiet, PercentPlantMatterEaten)
